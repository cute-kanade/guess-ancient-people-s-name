...
对比 v2.02 的改进：
    ...
    ✅ 向后兼容：旧版 app_01_* / app_02_* 归档到 legacy/
...
from people_db import load_people, get_person_by_name
...
st.caption("🔧 架构分层 + 结构化人物库 + 批量重答核查 | 旧版见 legacy/")
